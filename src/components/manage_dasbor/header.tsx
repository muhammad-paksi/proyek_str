...
export default function Header() {
  ...
  const floor = pathname.split("/")[3];
  const [isSidebarOpen, setIsSidebarOpen] = useState<boolean>(false);

  return (
    <>
      <header className="w-full h-[8vh] flex items-center justify-between py-2 pl-7 pr-12 border-b border-b-gray-300 bg-white">
        {/* LEFT NAV */}
              ...
              items: [
                {
                  key: "lantai_6",
                  label: "Lantai 6",
                  onClick: () => router.push("/dasbor/manage/lantai_6"),
                },
                {
                  key: "lantai_7",
                  label: "Lantai 7",
                  onClick: () => router.push("/dasbor/manage/lantai_7"),
                },
                {
                  key: "lantai_8",
                  label: "Lantai 8",
                  onClick: () => router.push("/dasbor/manage/lantai_8"),
                },
              ],
              selectable: true,
